...
The frozen benchmark is published as the `0.4.1` frontend release contract. Confirm the checked-in suite, its eight briefs, and deterministic example assets before running external candidates:
