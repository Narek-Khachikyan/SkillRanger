...
const common = (input: {
  ...
  // participates. Every other routed outcome is limited deterministic fallback and
  // carries the stable recall warning in its canonical deduplicated warning collection:
  // the decision itself produced it, so this adapter only passes it through.
