...
export const ruFrontendIntentAliases: FrontendIntentAliasPack = {
  ...
  intents: {
    ...
    "visual-design-polish": {
      ...
      phrases: ["визуальное направление", "визуальный дизайн", "визуальным дизайном", "визуальное качество", "улучшить иерархию", "убрать типовой ai интерфейс", "освежить дизайн"],
    },
  },
  controls: {
