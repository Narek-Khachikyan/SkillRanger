...
export const ruFrontendIntentAliases: FrontendIntentAliasPack = {
  ...
  intents: {
    ...
    "visual-design-polish": {
      ...
      phrases: ["визуальное направление", "визуальный дизайн", "визуальным дизайном", "визуальное качество", "интерактивный музейный опыт", "конфигуратор продукта", "редакционный data story", "улучшить иерархию", "убрать типовой ai интерфейс", "освежить дизайн"],
    },
  },
  controls: {
